...
(async() => {
    ...
    console.log('page');
    const pathName = "/Users/leamo/data/mdh/pdf/nuokang/";
    await page.goto(BASE_URL + '#/nuokang??objectStr=' + args[0],
        {
    ...
    // console.log(args[0]);
    // const browser = await puppeteer.launch({ headless: false, devtools: true, args: ['--no-sandbox', '--disable-dev-shm-usage', '--disable-setuid-sandbox']});
    // console.log(browser);
    // const page = await browser.newPage();
    // console.log(page);
    // const pathName = "/Users/leamo/data/mdh/pdf/nuokang/";
