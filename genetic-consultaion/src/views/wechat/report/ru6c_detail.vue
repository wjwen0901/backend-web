...
export default {
  ...
  methods: {
    toViewReport () {
      this.$router.push({path: '/report/view/', query: {path: this.$route.query.path}})
    }
  },
  filters: {
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .result-list {
    ...
    /*.result-info:not(:first-child) > :before,*/
    /*.result-info:not(:first-child) > :after*/
    /*{*/
      /*content: '';*/
      /*display: block;*/
      /*width: 100%;*/
      ...
      /*top: 0;*/
      /*left: 0;*/
      /*border-bottom: 1px solid rgba(101, 194, 196, .5);*/
    /*}*/
  }
  .el-table .row-class {
