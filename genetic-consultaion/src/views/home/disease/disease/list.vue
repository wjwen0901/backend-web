...
export default {
  ...
  data () {
    return {
      diseaseList: [],
      pageNum: window.sessionStorage.diseasePageSize === undefined ? 1 : window.sessionStorage.diseasePageSize,
      pageSize: window.sessionStorage.diseasePageNum === undefined ? 20 : window.sessionStorage.diseasePageNum,
      totalPage: 0,
      paramSelect: '',
      condition: null
    }
