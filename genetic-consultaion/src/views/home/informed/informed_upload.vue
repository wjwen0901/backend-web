          ...
          FileUploaded: (up, file, info) => {
            ...
            if (info.status === 200) {
              ...
              if (isNaN(parseInt(this.informedConsent.hospital))) {
                ...
                param.hospitalName = this.informedConsent.hospital
              } else {
                window.localStorage.hospital = this.informedConsent.hospital
                param.hospitalId = this.informedConsent.hospital
              }
              if (isNaN(parseInt(this.informedConsent.dept))) {
                window.localStorage.deptName = this.informedConsent.dept
                param.deptName = this.informedConsent.dept
              } else {
